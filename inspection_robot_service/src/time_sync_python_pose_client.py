...
class PoseStampedCreator(Node):
    ...
    def __init__(self):
        ...
        self.i = 0
        self.can_move_to_next_pose = True # False
    ...
    def process_pose(self):
        ...
        pose_tool0.pose.position.y += 0.01 # Move the pose 1 cm backwards in the y direction
    ...
    def simple_feedback(self):
        ...
        if self.focus_pose_dict:
            ...
            # max_focus_pose = self.focus_pose_dict[self.curr_max_fv]
            ...
            if (self.previous_ema - self.ema_focus_value) > 2:
                ...
                print('MAX FOCUS VALUE: ', self.curr_max_fv)
